...
// PV/CA não vêm sincronizados do Foundry (reverseCharacter.js não manda esses campos de
// volta pro site hoje) — por decisão do usuário, viram campos MANUAIS aqui: o jogador
// preenche à mão, sem refletir o estado real do Foundry. (`conditions` continua no
// personagem, mas o site não tem mais tela pra ele: as condições são do app.)
...
export function createEmptyCharacter() {
  return {
    ...
    derivedFrom: null,
    inspiration: false,
    // PV continua manual (não sincronizado do Foundry) — ver comentário acima.
